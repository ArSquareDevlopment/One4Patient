...
//  iChat
//
//  Created by David Kababyan on 11/06/2018.
...
class ProfileViewTableViewController: UITableViewController {
    ...
    @IBAction func chatButtonPressed(_ sender: Any) {
        ...
        if !checkBlockedStatus(withUser: user!) {
            ...
            let chatVC = PatientChatViewController()
    ...
    func callUser() {
        ...
        let callVC = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "CallVC") as! CallViewControllers
